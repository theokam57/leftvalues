...
const t = {
  pl: {
    ...
    mode_full: 'Pełny', mode_full_desc: '130 pytań · precyzyjny wynik',
    ...
    ideo_title: 'Wszystkie ideologie', ideo_subtitle: 'Poznaj wartości każdej lewicowej ideologii według 8 osi. Kliknij kartę, aby dowiedzieć się więcej.',
  ...
  en: {
    ...
    mode_full: 'Full', mode_full_desc: '130 questions · precise result',
    ...
    ideo_title: 'All ideologies', ideo_subtitle: 'Explore the values of each left-wing ideology across 8 axes. Click a card to learn more.',
  ...
  de: {
    ...
    mode_full: 'Vollständig', mode_full_desc: '130 Fragen · präzises Ergebnis',
    ...
    ideo_title: 'Alle Ideologien', ideo_subtitle: 'Entdecke die Werte jeder linken Ideologie auf 8 Achsen. Klicke auf eine Karte für mehr Infos.',
  ...
  ru: {
    ...
    mode_full: 'Полный', mode_full_desc: '130 вопросов · точный результат',
    ...
    ideo_title: 'Все идеологии', ideo_subtitle: 'Изучите ценности каждой левой идеологии по 8 осям. Нажмите на карточку, чтобы узнать больше.',
